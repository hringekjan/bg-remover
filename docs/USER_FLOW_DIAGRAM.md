...
│              pk                 │              sk               │
├─────────────────────────────────┼───────────────────────────────┤
│ TENANT#carousel-labs#JOB        │ JOB#abc-123-def               │
│ TENANT#carousel-labs#JOB        │ JOB#xyz-456-ghi               │
│ TENANT#carousel-labs#RATELIMIT  │ ACTION#process#WINDOW#1703...  │
│ TENANT#hringekjan#JOB           │ JOB#mno-789-pqr               │
│ TENANT#hringekjan#RATELIMIT     │ ACTION#process#WINDOW#1703...  │
└─────────────────────────────────┴───────────────────────────────┘
```
